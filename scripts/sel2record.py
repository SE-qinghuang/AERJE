...
def main(g,p):
    ...
    parser.add_argument('-g', dest='gold_folder', default= g,help='Gold Folder') ###'data/text2spotasoc/absa/14lap/'
    parser.add_argument('-p', dest='pred_folder', default=[p],nargs='+', help='Pred Folder') ###'output/'

    parser.add_argument('-c', '--config', dest='map_config', default="./config/offset_map/closest_offset_en.yaml",help='Offset Mapping Config')
