...
from AERJE.seq2seq.constraint_decoder import get_constraint_decoder
...
class ConstraintSeq2SeqTrainingArguments(Seq2SeqTrainingArguments):
    ...
    save_better_checkpoint: bool = field(default=True,metadata={"help": "Whether to save better metric checkpoint"})
...
class ConstraintSeq2SeqTrainer(Seq2SeqTrainer):
    ...
    def _maybe_log_save_evaluate(self, tr_loss, model, trial, epoch):
        ...
        # if not self.control.should_log:
        #     logs: Dict[str, float] = {}
        ...
        if self.control.should_log:
            ...
            logs["val_loss"] = round(tr_loss_scalar / (self.state.global_step - self._globalstep_last_logged), 4)
