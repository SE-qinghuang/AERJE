...
from aerje.extraction.predict_parser import get_predict_parser
from aerje.sel2record.record import EntityRecord, MapConfig, RelationRecord, EventRecord
import logging
...
class SEL2Record:
    ...
    def load_schema_dict(schema_folder):
        schema_dict = dict()
        for schema_key in ['record', 'entity', 'relation']:  ####   changed   ####
